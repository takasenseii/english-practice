...
const PHRASES = [
  ...
  { phrase: "drop off", sentence: "I’ll drop you off at the station.", correct: "take someone somewhere and leave them there", wrong: ["invite in", "teach", "argue"] },
  ...
  { phrase: "set out", sentence: "The report sets out the main findings.", correct: "present clearly (in writing)", wrong: ["hide", "cancel", "guess"] },
  ...
  { phrase: "break a promise", sentence: "He broke his promise again.", correct: "fail to do what he promised", wrong: ["keep it", "rewrite it", "celebrate it"] },

  { phrase: "take a stand", sentence: "She took a stand against bullying.", correct: "state a firm opinion", wrong: ["stay silent", "change topic", "avoid people"] },
  { phrase: "make a claim", sentence: "The article makes a strong claim.", correct: "state something as true", wrong: ["ask a question", "tell a joke", "deny"] },
  { phrase: "support a claim", sentence: "Use evidence to support your claim.", correct: "back up with evidence", wrong: ["hide", "ignore", "cancel"] },
  { phrase: "raise an issue", sentence: "He raised an issue about safety.", correct: "bring up a problem/topic", wrong: ["solve it fully", "ignore it", "laugh at it"] },
  ...
  { phrase: "take a suggestion", sentence: "I’ll take your suggestion.", correct: "accept/adopt an idea", wrong: ["ignore", "deny", "delete"] },
  { phrase: "reach a goal", sentence: "He reached his goal this month.", correct: "achieve a target", wrong: ["fail completely", "postpone", "forget"] }
...
{ phrase: "get away with", sentence: "He thought he could get away with cheating.", correct: "do something wrong without being punished", wrong: ["apologise immediately", "get permission", "improve skills"] },
...
{ phrase: "look down on", sentence: "It’s wrong to look down on people.", correct: "think someone is inferior", wrong: ["admire", "help", "copy"] },
{ phrase: "look up to", sentence: "Many students look up to their coach.", correct: "respect/admire", wrong: ["ignore", "argue with", "compete with"] },
{ phrase: "look back on", sentence: "She looks back on her school years with pride.", correct: "think about the past", wrong: ["predict the future", "deny", "complain"] },

{ phrase: "look around", sentence: "Let’s look around before we decide.", correct: "explore/inspect", wrong: ["leave", "forget", "hide"] },
{ phrase: "look over", sentence: "Can you look over my essay?", correct: "check/review", wrong: ["throw away", "copy", "shout"] },
{ phrase: "look through", sentence: "I looked through my notes for the answer.", correct: "search by examining", wrong: ["burn", "summarise", "celebrate"] },
{ phrase: "come across as", sentence: "He comes across as confident in interviews.", correct: "seem/appear", wrong: ["arrive late", "change clothes", "be injured"] },
...
{ phrase: "come along", sentence: "Come along—we’re leaving now.", correct: "go with/come with", wrong: ["stop", "forget", "hide"] },
...
{ phrase: "come up against", sentence: "We came up against some serious problems.", correct: "face/encounter", wrong: ["avoid", "celebrate", "solve instantly"] },

{ phrase: "go over", sentence: "Let’s go over the instructions again.", correct: "review", wrong: ["ignore", "cancel", "invent"] },
{ phrase: "go off", sentence: "The alarm went off at 6 a.m.", correct: "start ringing/exploding (device)", wrong: ["stop working", "get repaired", "get lost"] },
{ phrase: "go out", sentence: "The lights went out during the storm.", correct: "stop shining/working", wrong: ["get brighter", "get painted", "get sold"] },
...
{ phrase: "go with", sentence: "Let’s go with your idea.", correct: "choose/accept", wrong: ["reject", "erase", "delay"] },
{ phrase: "go without", sentence: "We can’t go without water.", correct: "manage without having", wrong: ["waste", "replace", "measure"] },
