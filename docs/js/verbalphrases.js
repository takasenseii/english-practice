...
const PHRASES = [
  ...
  { phrase: "keep up with", sentence: "It’s hard to keep up with the homework.", correct: "stay at the same level", wrong: ["cancel", "copy", "laugh at"] },
  { phrase: "catch up", sentence: "I need to catch up on sleep.", correct: "reach the same level again", wrong: ["fall behind", "give away", "slow down"] },
  { phrase: "calm down", sentence: "Please calm down and listen.", correct: "become less upset", wrong: ["become angry", "leave", "celebrate"] },
